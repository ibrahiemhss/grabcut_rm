...
#	of the application window,including several buttons.
	...
	def OnSetRegion(self, event):
		...
		if fn==[]:
			wx.MessageBox("Please open a image file before you set the GrabCut_py region!",
	...
	def OnRun(self, event):
		fn=self.doodle.GetFilename()
		if fn==[]:
			wx.MessageBox("You should open a image file before you run the GrabCut_py algorithm!",
							"oops!", style=wx.OK|wx.ICON_EXCLAMATION)
		else:
...
#	consists of a doodle window and a control panel.
	def __init__(self, parent):
		wx.Frame.__init__(self, parent, -1, "GrabCut_py", size=(638,512),
